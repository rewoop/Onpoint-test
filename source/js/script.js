...
(function () {
  ...
  var dateWrapper = footer.querySelector('.toggle__date-wrapper');
  ...
  var thirdPageFirstSlide = thirdPage.querySelector('.first-slide');
  var thirdPageSecondSlide = thirdPage.querySelector('.second-slide');
  var thirdPageThirdSlide = thirdPage.querySelector('.third-slide');
